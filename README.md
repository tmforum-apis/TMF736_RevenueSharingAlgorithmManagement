...
TM Forum Open API (Apache 2.0) Revenue Sharing Algorithm Management API.

Revenue Sharing Algorithm Management API goal is to provide the Algorithm to calculate a revenue share.
